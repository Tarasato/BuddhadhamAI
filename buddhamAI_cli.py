...
try:
    ...
    def ask(query, index, metadata, top_k=None, max_distance=None):
        ...
        response = ollama.chat(
            model=model,
            messages=[
                {"role": "system", "content": "คุณคือผู้ช่วยที่ใช้ข้อมูลอ้างอิงจากเอกสารหลายแหล่ง ซึ่งจะช่วยตอบคำถามเกี่ยวกับพระพุทธรรมและจะตอบด้วยภาษาไทยถ้าผู้ใช้ถามด้วยภาษาไทยหรือภาษาอังกฤษถ้าผู้ใช้ถามด้วยภาษาอังกฤษโดยเช็คจากคำถามก่อนซึ่งจะระบุในบรรทัดสุดท้ายถ้าได้รับคำถามนอกเหนือจากพระพุทธรรมให้ตอบว่า ขออภัยครับ...ผมไม่สามารถตอบคำถามนี้ได้....เนื่องจากผมถูกออกแบบมาเพื่อให้ตอบคำถามเกี่ยวกับพระพุทธธรรมเท่านั้น"},
