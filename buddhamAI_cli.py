    ...
    def ask(query, index, metadata, top_k=None, max_distance=None):
        ...
        response = ollama.chat(
            ...
            messages=[
                ...
                {"role": "user", "content": f"ให้คิดก่อนว่าเนื้อหาของคำถามนี้เกี่ยวกับพระพุทธศาสนาไหมถ้าไม่ใช่ให้ตอบว่า \"ขออภัยครับ...ผมไม่สามารถตอบคำถามนี้ได้....เนื่องจากผมถูกออกแบบมาเพื่อให้ตอบคำถามเกี่ยวกับพระพุทธธรรมเท่านั้น\" แต่ถ้าใช่ให้ตอบคำถามนี้ {prompt}"}
            ]
        )
